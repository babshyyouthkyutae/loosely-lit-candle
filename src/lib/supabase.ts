...
export const TOPPING_MAP: Record<string, ToppingMeta> = {
  ...
  "여행": { emoji: "✈️", label: "여행 캔디", soundType: "chime", color: "#4A90C4",
    tagLabel: "여행",
  ...
  "게임": { emoji: "🎮", label: "게임 젤리", soundType: "crunchy", color: "#3D5A80",
    tagLabel: "게임",
  ...
  "요리": { emoji: "🍳", label: "정성 쿠키", soundType: "crunchy", color: "#E8A050",
    tagLabel: "요리",
    svgPath: "M9 12h6M9 16h6M4 8h16M4 4h16v4H4V4zm0 4v12a2 2 0 002 2h12a2 2 0 002-2V8H4z" },
  "운동": { emoji: "🏃", label: "활력 젤리", soundType: "chime", color: "#E04F5F",
    tagLabel: "운동",
    svgPath: "M13 10V3L4 14h7v7l9-11h-7z" },
  "그림": { emoji: "🎨", label: "수채화 팔레트 쿠키", soundType: "fluffy", color: "#C45FA0",
    tagLabel: "그림",
